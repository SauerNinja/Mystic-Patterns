...
All files are flat at the repository root — no subfolders.

- `index.html` — the article
- `README.md` — this file
- `MIT LICENSE` — license and citation terms
...
- `favicon-16.png`, `favicon-32.png`, `favicon-180.png` — favicon set

## License

Released under the MIT License. See `MIT LICENSE` for full terms. Based on thoughts by Setvin Noether (@SauerNinja).

Suggested citation:

> Noether, S. "Mystic Patterns: How Altered Brains Manufacture Meaning." sauerninja.github.io/Mystic-Patterns, 2026.
